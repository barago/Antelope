...
(
    ...
    [Dialogueur2Id] INT NOT NULL, 
    [Dialogueur3Id] INT NOT NULL, 
    [Entretenu1Id] INT NOT NULL, 
    [Entretenu2Id] INT NOT NULL, 
    [Entretenu3Id] INT NOT NULL, 
    [ServiceTypeDialogueur1Id] INT NOT NULL, 
    [ServiceTypeDialogueur2Id] INT NOT NULL, 
    [ServiceTypeDialogueur3Id] INT NOT NULL, 
    [ServiceTypeEntretenu1Id] INT NOT NULL, 
    [ServiceTypeEntretenu2Id] INT NOT NULL, 
    [ServiceTypeEntretenu3Id] INT NOT NULL, 
